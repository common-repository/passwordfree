    ...
    public static function password_free_get_css_data($array, $width, $height): string
    {
        ...
        $fonts = '
            @font-face {
                ...
                src: url("' . PASSWORD_FREE_URL . 'admin/fonts/SourceSansPro-Light.ttf");
            }
            @font-face {
                font-weight: 400;
                font-family: \'Source Sans Pro\';
                src: url("' . PASSWORD_FREE_URL . 'admin/fonts/SourceSansPro-Regular.ttf");
            }
            @font-face {
                font-weight: 600;
                font-family: \'Source Sans Pro\';
                src: url("' . PASSWORD_FREE_URL . 'admin/fonts/SourceSansPro-Semibold.ttf");
            }';
