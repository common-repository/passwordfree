...
class Password_Free_Activator
{
    ...
    public static function password_free_activation_requests()
    {

        $code = self::password_free_generate_string(10);
        ...
        $args = array(
            ...
            'body' => json_encode(array('url' => get_site_url(), 'code' => $code)));
        $response = password_free_remote_post(PASSWORD_FREE_ACTIVATION_URL, $args);
        ...
        if ($errors != '' && $errors['code'] != NULL) {
            ...
            $inner_key = self::password_free_generate_string(8);
    ...
    private static function password_free_generate_string($code_length): string
    {
