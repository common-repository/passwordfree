...
class Password_Free
{
    ...
    public function __construct()
    {
        ...
        $this->password_free_load_dependencies();
        $this->password_free_define_admin_hooks();
        $this->password_free_define_notification_hooks();
        $this->password_free_define_web_endpoints();
        $this->password_free_define_buttons();
        $this->password_free_define_interceptors();
        $this->password_free_define_update();
    }

    private function password_free_load_dependencies()
    {
    ...
    private function password_free_define_admin_hooks()
    {
    ...
    private function password_free_define_notification_hooks()
    {
    ...
    private function password_free_define_web_endpoints()
    {
    ...
    private function password_free_define_buttons()
    {
    ...
    private function password_free_define_interceptors()
    {
    ...
    private function password_free_define_update()
    {
