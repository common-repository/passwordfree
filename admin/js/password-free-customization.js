window.onload = function () {
    fillData(customizationVariables['layoutArray'], customizationVariables['alignmentArray'], customizationVariables['logoArray'],
        customizationVariables['textButtons'], customizationVariables['fonts'])
    document.getElementById('password-free-page-wrapper').style.display = 'block';
}
