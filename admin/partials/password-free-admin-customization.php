...
wp_enqueue_script("password-free-customization-js", PASSWORD_FREE_URL . 'admin/js/password-free-customization.js', '', '', true);
$array = array(
    'layoutArray' => $layout_array,
    'alignmentArray' => $alignment_array,
    'logoArray' => $logo_array,
    'textButtons' => $text_buttons,
    'fonts' => $fonts
);
wp_localize_script('password-free-customization-js', 'customizationVariables', $array);
?>
    ...
    <div class="password-free-customization-wrapper" id="password-free-customization-wrapper_id">
        ...
        <div class="password-free-customization-setting-wrapper">
                    ...
                    <div class="password-free-customization-settings-alignment-items">
                        ...
                        foreach ($alignment_array as $item) {
                            ...
                            <div class="password-free-customization-settings-alignment-item-wrapper"
                                 id="<?php echo esc_attr($item['wrapper_id']) ?>">
                                <div class="password-free-customization-settings-alignment-item"
                                     id="<?php echo esc_attr($item['item_id']) ?>"
                                     onclick="alignmentItems(<?php echo esc_js(htmlspecialchars(json_encode($alignment_array))) ?>, <?php echo esc_js($item['id']) ?>, false)">
                                    <div class="<?php echo esc_attr($item['inner_item_class']) ?>"></div>
                                    <div class="password-free-customization-settings-alignment-item-inner"></div>
                                </div>
                                <div class="password-free-customization-settings-alignment-item-text"><?php echo esc_attr($item['text'])  ?></div>
                            </div>
                        <?php }
                        ?>
                    </div>
                        ...
                        foreach ($logo_array as $item) {
                            ...
                            <div class="password-free-customization-settings-logo-item-wrapper"
                                ...
                                <div class="password-free-customization-settings-logo-item"
                                     id="<?php echo esc_attr($item['item_id']) ?>"
                                     onclick="logoItems(<?php echo esc_js(htmlspecialchars(json_encode($logo_array))) ?>, <?php echo esc_js($item['id']) ?>, false)">
                                    <img src="<?php echo esc_url($item['img']) ?>"/>
                                </div>
                                <div class="password-free-customization-settings-logo-item-text"><?php echo esc_html($item['text']) ?></div>
                            </div>
                        <?php }
                        ?>
                    </div>
                        ...
                        <div class="password-free-default-text-context">
                            ...
                            foreach ($text_buttons as $button) {
                                ...
                                <div class="password-free-default-text-btn"
                                     id="<?php echo esc_attr($button['btn_default_id']) ?>"
                                     onclick="changeDefaultTextStyle('<?php echo esc_js($button['id']) ?>', '<?php echo esc_js($button['btn_default_id']) ?>')">
                    ...
                    <div class="password-free-customization-settings-default-text-font">
                        ...
                        <div class="password-free-default-text-context">
                            ...
                            foreach ($text_buttons as $button) {
                                ?>
                                <div class="password-free-default-text-btn"
                                     id="<?php echo esc_attr($button['btn_hover_id']) ?>"
                                     onclick="changeHoverTextStyle('<?php echo esc_js($button['id']) ?>', '<?php echo esc_js($button['btn_hover_id']) ?>')">
            ...
            <div class="password-free-customization-show-buttons">
                ...
                <div class="password-free-customization-show-buttons-default">
                    <div class="password-free-button">
                        <img src="" alt="img">
        ...
        <div class="password-free-customization-btn">
            <button class="password-free-customization-btn-apply" id="password-free-customization-btn-apply-id"
                    onclick="pfApplyChanges('<?php echo esc_url(PASSWORD_FREE_CUSTOMIZATION_APPLY_URL) ?>', '<?php echo esc_url(PASSWORD_FREE_CUSTOMIZATION_APPLY_DEFAULT_URL) ?>','<?php echo esc_js(get_option(PASSWORD_FREE_INNER_KEY)) ?>')">
                Apply
            </button>
            <button class="password-free-customization-btn-default" id="password-free-customization-btn-default-id"
                    onclick="pfDefaultSettings('<?php echo esc_url(PASSWORD_FREE_CUSTOMIZATION_DEFAULT_URL) ?>', '<?php echo esc_js(get_option(PASSWORD_FREE_INNER_KEY)) ?>')">
