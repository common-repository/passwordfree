...
define("PASSWORD_FREE_PROTOCOL", is_ssl() ? 'https://' : 'http://');
define('PASSWORD_FREE_UPLOAD_URL_PATH', preg_replace('~^(https?://)~', PASSWORD_FREE_PROTOCOL, wp_upload_dir()['baseurl']));
define('PASSWORD_FREE_UPLOAD_DIR_PATH', wp_upload_dir()['basedir']);
const PASSWORD_FREE_BUTTONS_STYLE_DIR_NAME = '/password-free-uploads';
const PASSWORD_FREE_NAME = 'PasswordFree';
const PASSWORD_FREE_VERSION = '1.1.5';
const PASSWORD_FREE_SCHEDULE = 'password_free_schedule';

//NoPass url
const PASSWORD_FREE_ENV = 'https://wordpress.passwordfree.us';
